...
export async function generateDigestMessage(): Promise<string> {
  ...
  return `🍽️ *Meza Daily Digest* — ${now.toLocaleDateString("en-IN", { weekday: "long", day: "numeric", month: "short" })}
